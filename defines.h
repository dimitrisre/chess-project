...
/*   To struct move_bytes antiproswpeyei thn perigrafh mias kinhshs . 
 * To promote einai se pio kommati na metaferthei topioni. Bits einai to
 * pedio poy perigreafei thn kinhsh me ta akoloytha pedia.
...
/*
 * Union gia thn eykolh sygkrish 2 kinhsewn.
 *
 * */
typedef union {
    move_bytes b;
...
/*
 *struct me pedio gia to score ths kinhshs.
 *
 * */
typedef struct {
    move m;
...
/* stoixeio ths  history stack, me tis aparaithtes plhrofories 
 * gia na einai eykolo to undo ths kinhshs.
 * */
typedef struct {
    move m;
    int capture;
...
//ekswterikes dhlwseis poy xrishmopoioyntai sxedon se ola ta arxeia.
extern int color[64];
extern int piece[64];
extern int side;
extern int xside;
